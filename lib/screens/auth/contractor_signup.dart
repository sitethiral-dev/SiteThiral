              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: const Color(0xFF7ECFB3).withOpacity(0.15), borderRadius: BorderRadius.circular(8), border: Border.all(color: const Color(0xFF7ECFB3).withOpacity(0.3))),
                    child: Row(children: const [Icon(Icons.add, color: Color(0xFF7ECFB3), size: 16), SizedBox(width: 4), Text('Add', style: TextStyle(color: Color(0xFF7ECFB3), fontSize: 13, fontWeight: FontWeight.bold))]),
                  ),
                ),
              ]),
              const SizedBox(height: 12),
              ...
              ..._employees.asMap().entries.map((entry) {
                ...
                return Container(
                  ...
                  child: Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('Employee ${i + 1}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF7ECFB3))),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: const TextStyle(color: Colors.white30, fontSize: 14),
          prefixIcon: const Icon(Icons.lock_outline, color: Color(0xFF7ECFB3), size: 20),
